        ...
        <div className='w-full py-16 px-4 text-white'>
            <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
                ...
                <div className='my-4'>
                    ...
                    <div className='flex flex-col justify-between sm:flex-row w-full items-center'>
                        <input type="email" className='w-full p-3 rounded-md text-black flex' placeholder='Enter Email' />
